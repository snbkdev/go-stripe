...
func (app *application) VirtualTermiinalPaymentSucceeded(w http.ResponseWriter, r *http.Request) {
	var txnData struct {
...
func (app *application) SendPasswordResetEmail(w http.ResponseWriter, r *http.Request) {
	...
	// send mail
	err = app.SendMail("asanbek.best@mail.ru", payload.Email, "password reset request", "password-reset", data)
	if err != nil {
		app.errorLog.Println(err)
		app.badRequest(w, r, err)
		return
...
func (app *application) AllSales(w http.ResponseWriter, r *http.Request) {
	...
	allSales, lastPage, totalRecords, err := app.DB.GetAllOrdersPaginated(3, 1)
	if err != nil {
		app.badRequest(w, r, err)
		return
	}
...
// GetSale returns one subscriptions as a slice
